...
public class LibroDAOImp implements LibroDAO {
	...
	public Libro create(Libro libro) {
		...
		this.jdbcTemplate.update(SQL, new Object[] { libro.getTitulo(), libro.getNombreApellidos(), libro.getISBN() });
		return libro;
	}
	...
	public Libro update(Libro libro) {
		...
		this.jdbcTemplate.update(SQL,
				new Object[] { libro.getTitulo(), libro.getNombreApellidos(), libro.getISBN(), libro.getCodigo() });
		return libro;
	}
